...
class Handler extends ExceptionHandler
{
    ...
    {
        if (app()->environment() == 'production' && !$exception instanceof NotFoundHttpException && !$exception instanceof ValidationException && !$exception instanceof UnauthorizedHttpException && !$exception instanceof AuthenticationException && !$exception instanceof TokenMismatchException && !$exception instanceof MethodNotAllowedHttpException)
        {
    ...
    public function render($request, Throwable $exception)
    {
        if ($exception instanceof TokenMismatchException) {
            ...
            elseif (strpos($request->url(), '/inspection/') == true)
            {
