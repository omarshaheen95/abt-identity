                            ...
                            <div class="d-flex flex-column bg-white p-2 h-100" style="border-radius: 8px">
                                ...
                                <div class="row mt-1 px-1">
                                    <div class="col-7 d-flex flex-column pe-0">
                                        ...
                                        <div class="col-12 s-content"><span class="s-title"> Section : </span>{{ $std->grade_section ?? '-' }}</div>
{{--                                        <div class="col-12 s-content"><span class="s-title"> Nationality : </span>{{ $std->nationality ?? '-' }}</div>--}}
                                    </div>
