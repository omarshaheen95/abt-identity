...
<div class="page p-0">
    <div class="subpage-w">
        <div class="position-relative">
            <img src="{{ asset('assets_v1/media/reports/covers/identity_'.$lang.'_attainment.svg')}}" class="w-100" alt="">
    ...
    <div class="subpage-w">
        <div class="row">
            <div class="col-md-12 text-center">
                <img src="{{ asset("assets_v1/media/reports/identity_domains_".app()->getLocale().".svg") }}?v=3" width="90%"/>
            </div>
        </div>
    </div>
...
@foreach($schoolsData as $schoolId => $schoolData)
     @foreach($schoolData['arab_grades'] as $key => $arab_grade)
            @if($arab_grade->total)
                <div class="page">
                    <div class="subpage-w">
                        <div class="row text-center justify-content-center">
                            <div class="col-11">
                                <h5 class="section-title">{{$schoolData['school']->name}} - {{re('Attainment')}} {{ $arab_grade->title }}</h5>
                            </div>
                        </div>
                        <div class="row text-center justify-content-center">
                            <div class="col-11 ">
            ...
            @endif
        @endforeach
     @foreach($schoolData['non_arab_grades'] as $key => $non_arab_grade)
            @if($non_arab_grade->total)
                <div class="page">
                    <div class="subpage-w">
                        <div class="row text-center justify-content-center">
                            <div class="col-11">
                                <h5 class="section-title">{{$schoolData['school']->name}} - {{re('Attainment')}} {{ $non_arab_grade->title }}</h5>
                            </div>
                        </div>
                        <div class="row text-center justify-content-center">
                            <div class="col-11 ">
