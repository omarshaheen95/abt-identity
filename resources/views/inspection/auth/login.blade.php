...
@section('content')
    <section>
        <div class="form">
            <div class="form-card">
                <form id="login-form" action="/inspection/login" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="info">
                        <h1 class="title">{{t('Inspection Login')}} </h1>
                    </div>
                    <div class="body">
                        <div class="form-group">
                            ...
                            <div class="form-control-icon">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="ex: example@domain.com" required>
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group">
                            <div class="d-flex">
                                ...
                                <a class="ms-auto text-theme" href="/inspection/password/reset" style="font-size: 13px">{{t('Reset Password')}}</a>
                            </div>
                            <div class="form-control-icon">
                                <div class="icon">
                                    <svg id="Icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
