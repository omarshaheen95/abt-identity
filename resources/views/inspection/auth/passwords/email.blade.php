    ...
    <section>
        <div class="form">
            <div class="form-card">
                ...
                <form id="login-form"  action="{{ url('/inspection/password/email') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="header">
                        @if(app()->getLocale() == "ar")
                        ...
                        <a href="/inspection/login" class="back ">
                        ...
                        <div class="form-group">
                            <label for="password" class="form-label d-block">
                                <div class="d-flex justify-content-between">
                                    <span>{{t('Email')}}</span>
                                    <a href="/inspection/login" class="text-theme">{{t('Login')}}</a>
                                </div>
                            </label>
