...
@section('content')
    ...
    @endif
    <div class="row">
        <form class="form" id="form_data" action="{{route('inspection.update-password')}}" method="post">
            @csrf
...
@section('script')
    ...
    {!! JsValidator::formRequest(\App\Http\Requests\Inspection\InspectionPasswordRequest::class, '#form_data'); !!}
@endsection
